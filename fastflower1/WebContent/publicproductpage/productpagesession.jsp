...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <body>
					...
					<ul class="thumbnails">
						<li class="span6 big-preview">
							<div style="height: 608px;" class="thumbnail">
								<div class="img-wrap">
									<a href="images/bg4a1.jpg" class="colorbox cboxElement">	
										<img src="images/bg4a1.jpg" alt="" rel="gal">
									</a>
								</div>	
						...
						<div class="near-big">
							<div class="thumbnail-block clearfix">	
								<li class="span3">
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="images/image_3.jpg" class="colorbox cboxElement">
												<div class="black-bg">
												</div>	
												<img src="images/image_3.jpg" alt="" rel="gal">
											</a>
										</div>
										<h3 class="with-border">Roses</h3>
                                        <button type="submit"><a href="single.jsp">Select</a></button>
									</div>
								</li>
								<li class="span3">
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="images/bg3.jpg" class="colorbox cboxElement">
												...
												<img src="images/bg3.jpg" alt="" rel="gal">
											</a>
										</div>
										<h3 class="with-border">Purple bursts</h3>
									...
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="images/bg2.jpg" class="colorbox cboxElement">
												...
												<img src="images/bg2.jpg" alt="" rel="gal">
											</a>
										</div>
										<h3 class="with-border">Butterfly Flower</h3>
                                        <button type="submit">Select</button>
									</div>
								</li>
								<li class="span3">
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="images/image_1.jpg" class="colorbox cboxElement">
												...
												<img src="images/image_1.jpg" alt="" rel="gal">
											</a>
										</div>
								...
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_2.jpg" class="colorbox cboxElement">
											...
											<img src="images/image_2.jpg" alt="" rel="gal">
										</a>
									</div>
									<h3 class="with-border">Sakura</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_4.jpg" class="colorbox cboxElement">
											...
											<img src="images/image_4.jpg" alt="" rel="gal">
										</a>
									</div>
									<h3 class="with-border">Tulips</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									...
									<h3 class="with-border">Kapuru</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_5.jpg" class="colorbox cboxElement">
											...
											<img src="images/image_5.jpg" alt="" rel="gal">
										</a>
									</div>
									<h3 class="with-border">Jerbara</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
						</div>
								...
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_3a.jpg" class="colorbox cboxElement">
											...
											<img src="images/image_3a.jpg" alt="" rel="gal">
										</a>
									</div>
								...
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/bg4.jpg" class="colorbox cboxElement">
											...
											<img src="images/bg4.jpg" alt="" rel="gal">
										</a>
									</div>
								...
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/bg1a1.jpg" class="colorbox cboxElement">
											...
											<img src="images/bg1a1.jpg" alt="" rel="gal">
										</a>
									</div>
								...
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_6.jpg" class="colorbox cboxElement">
											...
											<img src="images/image_6.jpg" alt="" rel="gal">
										</a>
									</div>
									<h3 class="with-border">Sunflower</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
						</div>	
		...
		<div id="clients-bg" class="parallax" style="background-image: url(images/bg8.jpg);">
			<div class="black-bg">
				<div class="text">
					<blockquote>
		...
		<div id="blog-bg" class="parallax" style="background-image: url(images/bg7.jpg)">
			<div class="black-bg">
				<div class="text">
					<blockquote>
					...
					<ul class="thumbnails">
						<div class="row">
							<li class="span4">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="#"><img src="R/image_1.jpg" alt=""></a>
									</div>	
							...
							<li class="span4">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="#"><img src="R/image_2.jpg" alt=""></a>
									</div>
							...
							<li class="span4">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="#"><img src="R/team3.jpg" alt=""></a>
									</div>
						...
						<div class="row">	
							<li class="span4">
								<div class="thumbnail">
									<div class="img-wrap2">
										<a href="#"><img src="R/image_4.jpg" alt=""></a>
									</div>
							...
							<li class="span4">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="#"><img src="R/image_5.jpg" alt=""></a>
									</div>	
							...
							<li class="span4">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="#"><img src="R/image_6.jpg" alt=""></a>
									</div>
									<h3 class="with-border">Lorem ipsum dolor sit amet</h3>
									<div class="info-panel clearfix">
										<span class="pull-left"><time datetime=""><i class="icon-calendar "></i> Sep 19, 2013</time></span>
		...
		<div id="price-bg" class="parallax" style="background-image: url(images/bg9.jpg);">
			<div class="black-bg">
				<div class="text">
				  <blockquote>
						<h2>Island wide delivery Guaranteed Freshness</h2>
				  </blockquote>
				</div>
			</div>	
		</div>
