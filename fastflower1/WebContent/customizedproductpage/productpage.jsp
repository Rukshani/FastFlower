...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
		...
		<link href="productpage/R/bootstrap.css" rel="stylesheet" media="screen">
		<link href="productpage/R/bootstrap-responsive.css" rel="stylesheet" media="screen">
		<link rel="stylesheet" href="productpage/R/colorbox.css">
		<link href="productpage/R/css.css" rel="stylesheet" type="text/css">
		<link rel="stylesheet" href="productpage/R/main.css">
		<link rel="stylesheet" href="productpage/R/font-awesome.css">
        <script src="productpage/R/modernizr-2.js"></script>
    </head>
    <body>
		...
		<div id="welcome" class="parallax" style="background-image: url(&quot;productpage/images/bg1.jpg&quot;); background-position: 50% 0px;">
			...
			<div class="features dark-bg">
				<div class="container">
					<div class="row-fluid">
						...
						<article class="span3">
						<h3 class="color text-center with-border">Flowers & Gifts</h3>
							<p>For anybody who believes in beign a grand person</p>
						</article>
						<article class="span3">
							<h3 class="color text-center with-border">Coperate Events</h3>
							<p>We cater to government functions and provide flowers and decor at the most competitive rates</p>
						</article>
						<article class="span3">
							<h3 class="color text-center with-border">Wholesale & Retail</h3>
					...
					<div class="row-fluid section">
						...
						<div class="span6">
							...
							<div class="videoWrapper">
								<iframe src="productpage/R/20596477.htm" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" frameborder="0"></iframe>
							</div>						</div>
					</div>
					
				<div class="text-center">
						<a class="btn btn-large toSection" href="#" data-section="7">Contact us</a>
				  </div>
				</div>	
			</div>	
		</section>	
		
		<div id="services-bg" class="parallax" style="background-image: url(productpage/images/bg4.jpg);">
			<div class="black-bg">
				<div class="text">
					<blockquote>
		...
		<div id="works-bg" class="parallax" style="background-image: url(productpage/images/image_1.jpg);">
			<div class="black-bg">
				<div class="text">
			...
			<div class="light-bg">
				<div class="container">
					...
					<div style="height:auto" class="thumbnail">
                            <h2>fhdfafkakfhhafh</h2>
                    </div>
					<ul class="thumbnails">
						<li class="span6 big-preview">
							<div style="height: 608px;" class="thumbnail">
								<div class="img-wrap">
									<a href="productpage/images/bg4a1.jpg" class="colorbox cboxElement">	
										<img src="productpage/images/bg4a1.jpg" alt="" rel="gal">
									</a>
								</div>	
						...
						<div class="near-big">
							<div class="thumbnail-block clearfix">	
								<li class="span3">
									<div class="thumbnail" id="p1">
										<div class="img-wrap">
											<a href="productpage/images/image_3.jpg" class="colorbox cboxElement">
												<div class="black-bg">
												</div>	
												<img src="productpage/images/image_3.jpg" alt="" rel="gal" width="237" height="155">
											</a>
										</div>
										<h3 class="with-border"><a href="#">Roses</a></h3>
								...
								<li class="span3">
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="productpage/images/bg3.jpg" class="colorbox cboxElement">
												<div class="black-bg">
												</div>	
												<img src="productpage/images/bg3.jpg" alt="" rel="gal" width="237" height="155">
											</a>
										</div>
										<h3 class="with-border"><a href="#">Purple bursts</i></a></h3>
                                        <button type="submit">Select</button>
									</div>
								</li>
							</div>	
							<div class="thumbnail-block clearfix">
								<li class="span3">
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="images/bg2.jpg" class="colorbox cboxElement">
												<div class="black-bg">
												</div>	
												<img src="images/bg2.jpg" alt="" rel="gal" width="237" height="155">
											</a>
										</div>
										<h3 class="with-border"><a href="#">Butterfly Flower</a></h3>
                                        <button type="submit">Select</button>
									</div>
								</li>
								<li class="span3">
									<div class="thumbnail">
										<div class="img-wrap">
											<a href="images/image_1.jpg" class="colorbox cboxElement">
												<div class="black-bg">
												</div>	
												<img src="images/image_1.jpg" alt="" rel="gal" width="237" height="155">
											</a>
										</div>
										<h3 class="with-border">Pink blossoms</h3>
                                        <button type="submit">Select</button>
									</div>
								</li>
							</div>
						...
						<div class="row">
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_2.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/image_2.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border"><a href="#">Sakura</a></h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_4.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/image_4.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border"><a href="#">Tulips</a></h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/bg3.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/bg3.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border">Kapuru</a></h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_5.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/image_5.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border">Jerbara</a></h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
						</div>
						<div class="row">
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_3a.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/image_3a.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border">Blue roses</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/bg4.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/bg4.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border">Daisy</h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/bg1a1.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/bg1a1.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border">Violet tulips</h3>
                                     <button type="submit">Select</button>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<div class="img-wrap">
										<a href="images/image_6.jpg" class="colorbox cboxElement">
											<div class="black-bg">
											</div>	
											<img src="images/image_6.jpg" alt="" rel="gal" width="237" height="155">
										</a>
									</div>
									<h3 class="with-border">Sunflower</a></h3>
                                    <button type="submit">Select</button>
								</div>
							</li>
						</div>	
		...
		<div id="clients-bg" class="parallax" style="background-image: url(productpage/images/bg8.jpg);">
			<div class="black-bg">
				<div class="text">
					<blockquote>
						<h2>We decor your day</h2>
					</blockquote>
				</div>
			</div>	
		</div>
				  ...
				  <h2>&nbsp;</h2>
					...
					<div class="section">
						...
						<div class="clients-block">
							<div class="row-fluid">
								<article class="span2">
									<img src="productpage/images/client-1.png" alt="pro flowers">
								</article>
								<article class="span2">
									<img src="productpage/images/client-2.png" alt="">
								</article>
								<article class="span2">
									<img src="productpage/images/client-3.png" alt="">
								</article>
								<article class="span2">
									<img src="productpage/images/client-4.png" alt="">
								</article>
								<article class="span2">
									<img src="productpage/images/client-5.png" alt="">
								</article>
								<article class="span2">
									<img src="productpage/images/client-6.png" alt="">
								</article>
							</div>	
						</div>
					</div>	
		...
		<div id="blog-bg" class="parallax" style="background-image: url(productpage/images/bg7.jpg)">
			<div class="black-bg">
				<div class="text">
					<blockquote>
						<h2>For anybody who believes in being a grand person</h2>
					</blockquote>
				</div>
			</div>	
		</div>
	...
	<section id="contacts" class="text-block" data-section="7">
        ...
        <script src="productpage/R/jquery_002.js"></script>
        <script>window.jQuery || document.write('<script src="js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
		<script src="productpage/R/bootstrap.js"></script>
		<script src="productpage/R/waypoints.js"></script>
        <script src="productpage/R/plugins.js"></script>
		<script src="productpage/R/jquery.js"></script>
        <script src="productpage/R/main.js"></script>
